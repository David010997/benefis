...
import StarProfileMain from './StarProfileMain';
import {Link} from 'react-router-dom';
import AddVideForStarPage from './AddVideoForStarPage';
import ChangeStarPassword from './ChangeStarPassword';
                ...
                <Wrapper>
                                ...
                                <div className="container">
                                        ...
                                        <div className="img"><img src={Utils.fileUrl(avatar)} alt=""/>
                                            <form>
                                                <label className="custom-image-upload">
                                                    <input type="file" className="star-image-upload" name="file-upload"
                                    ...
                                    <nav className="main-nav" role="navigation">
                                        <ul className="main-menu">
                                            ...
                                            <li><AnchorLink href="#section3">My videos</AnchorLink></li>
                                            <li><AnchorLink href="#section4">Order view</AnchorLink></li>
                    ...
                    <ul className="social-icons">
                      ...
                      <li>
                        ...
                        <StarProfileMain/>
                        <ChangeStarPassword/>
                        <AddVideForStarPage videos={user.videos.filter(video => video.visibility === true)}/>
                        <OrderView user={user}/>
                    </div>
                </Wrapper>
            </div>
